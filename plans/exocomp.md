...
| M8 | [Hierarchical observe/manage policy](hierarchical-management-modes.md) | **Path 3 policy**: Observation-first hierarchical management authority with cluster-local enforcement | TBD |
