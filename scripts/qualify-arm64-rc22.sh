...
#
# Complete rc.21 arm64 qualification script.
# Runs all phases from scratch on the arm64 qualification VM (full-system QEMU).
# Evidence written to /var/lib/exocomp-qualification/rc22/evidence/

set -euo pipefail

VERSION="0.1.0-rc.22"
ARCH="arm64"
SOURCE_COMMIT="3d858d22bd0007c9237baae1bd5de2963cc3e50d"
QUAL_ROOT="/var/lib/exocomp-qualification"
SRC_DIR="${QUAL_ROOT}/src"
RC_DIR="${QUAL_ROOT}/rc22"
...
PREFLIGHT_SCRIPT="${QUAL_ROOT}/qualification-live-preflight-arm64-rc22.sh"
LIFECYCLE_SOURCE="${SRC_DIR}/scripts/qualification-live-lifecycle.sh"
LIFECYCLE_SCRIPT="${QUAL_ROOT}/qualification-live-lifecycle-arm64-rc22.sh"
...
echo "=== $(ts) START rc.21 arm64 qualification ==="
